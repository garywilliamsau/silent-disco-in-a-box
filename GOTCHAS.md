...
- **Spotify stuttering is an ongoing known issue.** See `DEBUG_SPOTIFY.md` for full diagnostic history and plan. Root cause likely in `spotify-capture.sh` FIFO/dd timing gaps or `input.external` clock domain mismatch.
